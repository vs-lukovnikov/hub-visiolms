 ...
 * @Plugin(
 *   id = "semantic_button",
 *   label = @Translation("Semantic Buttons")
 * )
 */
class SemanticButton extends StyleguidePluginBase {
  ...
  public function items() {
    ...
    $items['semantic-button-standard'] = [
      'title' => $this->t('Semantic Forms: Standard button'),
      'content' => $this->formBuilder->getForm('Drupal\styleguide\Form\StyleguideForm', ['button']),
      'group' => $this->t('Semantic Forms'),
    ];

    $items['semantic-button-primary'] = [
      'title' => $this->t('Semantic Forms: Primary button'),
      'content' => $this->formBuilder->getForm('Drupal\styleguide\Form\StyleguideForm', ['button']),
      'group' => $this->t('Semantic Forms'),
    ];
